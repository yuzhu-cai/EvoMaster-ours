...
1. **General training configuration**: ./robomimic/exps/paper_local/core/transport/ph/low_dim/bc_rnn.json
...
```
# In ./robomimic/exps/paper_local/core/transport/ph/low_dim/bc_rnn.json
...
```
Use file_editor to view ./robomimic/algo/bc.py and ./robomimic/exps/paper_local/core/transport/ph/low_dim/bc_rnn.json  (just example)
```
...
```bash
python robomimic/scripts/train.py --config robomimic/exps/paper/core/transport/ph/low_dim/bc_rnn.json
```
