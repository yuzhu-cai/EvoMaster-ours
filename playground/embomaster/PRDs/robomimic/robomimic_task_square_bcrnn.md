...
1. **General training configuration**: ./robomimic/exps/paper_local/core/square/ph/low_dim/bc_rnn.json
...
```
# In ./robomimic/exps/paper_local/core/square/ph/low_dim/bc_rnn.json
...
```
Use file_editor to view ./robomimic/algo/bc.py and ./robomimic/exps/paper_local/core/square/ph/low_dim/bc_rnn.json  (just example)
```
