...
1. **General training configuration**: ./robomimic/exps/paper_local/core/tool_hang/ph/low_dim/bcq.json
...
```
# In ./robomimic/exps/paper_local/core/tool_hang/ph/low_dim/bcq.json
...
```
Use file_editor to view ./robomimic/algo/bcq.py and ./robomimic/exps/paper_local/core/tool_hang/ph/low_dim/bcq.json  (just example)
```
...
```bash
python robomimic/scripts/train.py --config robomimic/exps/paper/core/tool_hang/ph/low_dim/bcq.json
```
