# **PRD: Improving Metaworld pick_place PPO Training Performance**

## **Objective**

Improve the PPO policy performance on the **pick_place** task.
...
4. **Training script**
   `./examples/single_task/ppo_pick_place.py`
