...
**Goal:** Maximize the success rates of the `adjust_bottle` tasks on the RoboTwin platform, and implement structured, reusable, and scalable automated improvements to the existing ACT code.
...
3. **Env code** (optional): ./envs/adjust_bottle.py
...
bash train.sh adjust_bottle demo_clean 50 0 0
