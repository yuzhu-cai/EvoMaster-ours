# **PRD: Improving Metaworld pick_out_of_hole PPO Training Performance**

## **Objective**

Improve the PPO policy performance on the **pick_out_of_hole** task.
...
4. **Training script**
   `./examples/single_task/ppo_pick_out_of_hole.py`
