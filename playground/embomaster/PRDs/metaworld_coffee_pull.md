# **PRD: Improving Metaworld coffee pull PPO Training Performance**

## **Objective**

Improve the PPO policy performance on the **coffee pull** task.
...
4. **Training script**
   `./examples/single_task/ppo_coffee_pull.py`
